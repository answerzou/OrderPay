...
- (void)viewDidLoad
{
    ...
    UIView *searchView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 40*(self.view.frame.size.height/568))];
    searchView.backgroundColor = [UIColor whiteColor];
    
    UIImageView *searchBg = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"bg_searchBar"]];
    ...
    _tableView.frame           = CGRectMake(0,searchView.frame.origin.y+searchView.frame.size.height, self.view.frame.size.width, self.view.frame.size.height-64 + 20);
...
- (void)setNavigationWithTitle:(NSString *)title
{
    ...
    [backBtn setExclusiveTouch:true];
...
- (void)ininHeaderView
{
    ...
    _tableHeaderView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, _tableView.frame.size.width, 50)];
    _tableHeaderView.backgroundColor = [UIColor clearColor];
    
    
    //定位城市
    UILabel *title1 = [[UILabel alloc]initWithFrame:CGRectMake(10, 10, 0, 21)];
    title1.text = @"定位城市";
    title1.font = [UIFont systemFontOfSize:15];
    [title1 sizeToFit];
    [_tableHeaderView addSubview:title1];
    
    _locatingCityGroupView = [[ButtonGroupView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(title1.frame), title1.frame.origin.y - 7, _tableHeaderView.frame.size.width, 45)];
...
//    [_tableHeaderView addSubview:_hotCityGroupView];
    ...
    _tableHeaderView.frame = CGRectMake(0, 0, _tableView.frame.size.width, 35);
